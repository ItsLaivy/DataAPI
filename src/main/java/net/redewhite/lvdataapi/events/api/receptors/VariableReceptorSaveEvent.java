...
public class VariableReceptorSaveEvent extends VariableReceptorEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;

    public VariableReceptorSaveEvent(VariableReceptor receptor, VariablesTable table) {
