...
public class VariableReceptorCreateEvent extends VariableReceptorEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;

    public VariableReceptorCreateEvent(VariableReceptor receptor) {
        super(receptor);
    }
