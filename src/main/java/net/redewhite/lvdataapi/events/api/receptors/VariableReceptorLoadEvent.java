...
public class VariableReceptorLoadEvent extends VariableReceptorEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();
    private boolean cancel = false;

    public VariableReceptorLoadEvent(VariableReceptor receptor, VariablesTable table) {
