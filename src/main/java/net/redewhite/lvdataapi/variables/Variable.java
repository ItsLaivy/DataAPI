...
public class Variable {
    ...
    public Variable(Plugin plugin, String name, Object default_value, Boolean textvariable) {
        new VariableCreationController(plugin, name, default_value, LvDataAPI.variableType.NORMAL, textvariable, false);
    }
    public Variable(Plugin plugin, String name, Object default_value) {
        new VariableCreationController(plugin, name, default_value, LvDataAPI.variableType.NORMAL, false, false);
    }
